---
title: "Code Quality Improvement Report — Gdpr"
type: report
tags: [code-quality, phpstan, pest, maintainability]
module: "Gdpr"
created: 2026-07-17
updated: 2026-07-17
qmd: "code quality baseline PHPStan Pest strict types Laraxot Gdpr"
story: STORY-001
issues:
...
# Code Quality Improvement Report — Gdpr
...
| Indicatore | Valore |
|---|---:|
| File PHP applicativi/database/route | 94 |
| File di test PHP | 39 |
| Rapporto test/file PHP | 41% |
| Candidati senza strict types | 94 |
