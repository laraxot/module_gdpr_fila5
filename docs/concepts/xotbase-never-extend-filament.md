...
type: concept
module: Gdpr
tags: [gdpr, filament, xotbase, architecture]
created: 2026-07-16
updated: 2026-07-16
qmd: "Gdpr filament never extend Filament class XotBase mirror path"
related:
...
Nessuna classe in `Modules/Gdpr` estende una classe `Filament\...` direttamente.
