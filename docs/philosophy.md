...
### Models (4, verified against `app/Models/` 2026-09-17)
...
- **Treatment** — Data treatment/processing purpose definition
- **Profile** — GDPR-related profile data

(No `ConsentCategory` model exists in the code; the earlier version of this
doc named one that was never implemented — categories are a `type` field on
`Consent`, not a separate model.)
