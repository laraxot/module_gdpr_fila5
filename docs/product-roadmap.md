...
> Maturita' stimata: 66% implementato, 34% gap residuo.

## Visione di avanzamento

Questo roadmap traduce il PRD in sequenza di rilascio per **Gdpr**, che nel progetto copre: consensi, privacy e conformita' normativa.
