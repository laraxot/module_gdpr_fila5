...
# Gdpr {{TYPE^}} LLM Wiki Agent Instructions

> **Module/Theme:** Gdpr
> **Scope:** Gdpr-specific knowledge only
> **Created:** 2026-04-15
> **Based on:** Karpathy's LLM Wiki pattern

## Role

You are the **Gdpr Wiki Maintainer**. Your job is to:
...
- Concept is unique to Gdpr
- Pattern is Gdpr-specific
- Decision only affects Gdpr
