...
Le Commands progettuali vivono qui, nel wiki del Module **Gdpr**, e vengono caricate **on-demand**.
...
=======
# Gdpr Module - commands Index

## Purpose
Index for Gdpr module commands.

## On-Demand Loading

```bash
qmd search "Gdpr commands" --limit 5
```
