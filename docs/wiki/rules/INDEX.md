...
Le Rules progettuali vivono qui, nel wiki del Module **Gdpr**, e vengono caricate **on-demand**.
...
=======
# Gdpr Module - rules Index

## Purpose
Index for Gdpr module rules.

## On-Demand Loading

```bash
qmd search "Gdpr rules" --limit 5
```
