...
Le Skills progettuali vivono qui, nel wiki del Module **Gdpr**, e vengono caricate **on-demand**.
...
=======
# Gdpr Module - skills Index

## Purpose
Index for Gdpr module skills.

## On-Demand Loading

```bash
qmd search "Gdpr skills" --limit 5
```
